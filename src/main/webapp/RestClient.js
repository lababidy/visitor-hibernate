...
// Model for Course entity
    models.Course = Backbone.Model.extend({
        urlRoot: "http://localhost:8080/visitor-hibernate-2/webresources/org.lababidy.visitor.hibernate.course/",
        idAttribute: 'cid',
        defaults: {
            cname: "",
            cnotes: ""
        ...
        toViewJson: function () {
            ...
            result.displayName = this.get('cid');
            return result;
        },
        isNew: function () {
        ...
        sync: function (method, model, options) {
            ...
            if (method == 'create') {
                options.url = 'http://localhost:8080/visitor-hibernate-2/webresources/org.lababidy.visitor.hibernate.course/';
            }
    ...
    models.CourseCollection = Backbone.Collection.extend({
        model: models.Course,
        url: "http://localhost:8080/visitor-hibernate-2/webresources/org.lababidy.visitor.hibernate.course/",
        sync: function (method, model, options) {
            options || (options = {});
            var errorHandler = {
                error: function (jqXHR, textStatus, errorThrown) {
